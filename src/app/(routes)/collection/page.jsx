                ...
                <div className='w-[77%] flex flex-row flex-wrap pl-[5%] pr-[5%] justify-between'>
                    <div className='w-[45%] h-[350px] mb-[30px]'>
                        ...
                        <div className='mt-[5px]'>
                            ...
                            <div className='text-[15px]'>Coastal – miền duyên hải, hứa hẹn sẽ mang đến cảm giác mát lành của biển xanh, cát vàng và [...]</div>
                        </div>
                    </div>
                    ...
                    <div className='w-[45%] h-[350px] mb-[30px]'>
                        ...
                        <div className='mt-[5px]'>
                            ...
                            <div className='text-[15px]'>Cabo là BST mới nhất vừa có mặt tại Nhà Xinh trong thời gian gần đây, hứa hẹn sẽ mang [...]</div>
                        </div>
                    </div>
                    ...
                    <div className='w-[45%] h-[350px] mb-[30px]'>
                        ...
                        <div className='mt-[5px]'>
                            ...
                            <div className='text-[15px]'>Với nguồn cảm hứng từ những đường khối vuông vức, BST Osaka mang đến vẻ đẹp vững chắc và mạnh [...]</div>
                        </div>
                    </div>
                    ...
                    <div className='w-[45%] h-[350px] mb-[30px]'>
                        ...
                        <div className='mt-[5px]'>
                            ...
                            <div className='text-[15px]'>Lấy cảm hứng từ nội thất tinh xảo, nhẹ nhàng, nền nã nhưng đơn giản Elegance là sự kết hợp [...]</div>
                        </div>
                    </div>
                    ...
                    <div className='w-[45%] h-[350px] mb-[30px]'>
                        ...
                        <div className='mt-[5px]'>
                            ...
                            <div className='text-[15px]'>Nét mộc mạc và sang trọng trong thiết kế vô cùng độc đáo bởi nhà thiết kế Đan Mạch [...]</div>
                        </div>
                    </div>
                    ...
                    <div className='w-[45%] h-[350px] mb-[30px]'>
                        ...
                        <div className='mt-[5px]'>
                            ...
                            <div className='text-[15px]'>Bộ sưu tập Mây gợi lại những hồi ức thanh bình và gần gũi của hồn quê Việt cho lối [...]</div>
                        </div>
                    </div>
                    ...
                    <div className='w-[45%] h-[350px] mb-[30px]'>
                        ...
                        <div className='mt-[5px]'>
                            ...
                            <div className='text-[15px]'>BST nội thất Maxine mang phong cách hiện đại với các chi tiết sang trọng và quyến rũ đến kỳ [...]</div>
                        </div>
                    </div>
                    ...
                    <div className='w-[45%] h-[350px] mb-[30px]'>
                        ...
                        <div className='mt-[5px]'>
                            ...
                            <div className='text-[15px]'>Bộ sưu tập JAZZ được thiết kế với phong cách Industrial. Phong cách này phù hợp với nhiều loại hình [...]</div>
                        </div>
                    </div>
                    ...
                    <div className='w-[45%] h-[350px] mb-[30px]'>
                        ...
                        <div className='mt-[5px]'>
                            ...
                            <div className='text-[15px]'>Nhà thiết kế Huy Lân bắt nguồn cho những cảm hứng của mình từ nét đẹp tinh xảo của những [...]</div>
                        </div>
                    </div>
                    ...
                    <div className='w-[45%] h-[350px] mb-[30px]'>
                        ...
                        <div className='mt-[5px]'>
                            ...
                            <div className='text-[15px]'>Sự kết hợp độc đáo giữa gỗ Sồi nâu Hi Tech Veneer và chân kim loại copper giúp bộ sưu [...]</div>
                        </div>
                    </div>
                </div>
            </div>
