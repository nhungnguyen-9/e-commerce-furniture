...
const ImageUpload = ({ onChange, onRemove, value }) => {
    ...
    return (
        <div className="">
            ...
            <label htmlFor="imageUpload" className="bg-gray-600 w-[15%] text-white flex items-center gap-1 p-3 rounded-md hover:bg-gray-700 cursor-pointer">
