...
import { deleteRoom } from '@/backend/services/admin/room'
import { toast } from 'react-toastify'
import { useRouter } from 'next/navigation'
import { deleteImage } from '@/app/utils/cloudinary/image'
import { deleteCategory } from '@/backend/services/admin/category'

export default function DeleteCategory({ id, publicId, onDeleteSuccess }) {
