                        ...
                        <div className="container max-w-screen-xl mx-auto px-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-5">
                                ...
                                <main>
                                    ...
                                    <div className="flex items-center gap-8 my-5">
                                        <div className="flex flex-col gap-2">
                                            <div className="flex gap-4 items-center shadow-md p-3 ">
                                                <Minus
                                                    className="hover:text-slate-600 cursor-pointer border-2 rounded-md border-black"
                                    ...
                                    <div className='text-center mt-2 mb-4 text-[14px]'>Liên hệ tư vấn và đặt mua: <div className='text-red-600 inline'>18007200</div></div>
                                    <div className='my-5'>
                                        <AppBar position="static" sx={{ bgcolor: 'white', '& .MuiTabs-indicator': { backgroundColor: 'orange' }, boxShadow: 'none', borderBottom: '1px solid grey' }}>
                                            <Tabs
                                                value={value}
                                            ...
                                            // }}
                                            >
                                                <Tab label="Mô tả" {...a11yProps(0)} sx={{ color: 'black', fontSize: '16px', fontWeight: 'bold' }} />
                                                <Tab label="Bảo hành" {...a11yProps(0)} sx={{ color: 'black', fontSize: '16px', fontWeight: 'bold' }} />
                                                <Tab label="Vận chuyển" {...a11yProps(1)} sx={{ color: 'black', fontSize: '16px', fontWeight: 'bold' }} />
                                            </Tabs>
                                        </AppBar>
                                        <div
